...
class slideMenu extends Component {
  ...
  render() {
    return (
      <div>
        <div>
          <img width="100%" height="64px" src="/assets/logo.png" />
        </div>
        <Menu onClick={this.handleClick} mode="inline" defaultSelectedKeys={['home-index']} defaultOpenKeys={['home-index']}>
          ...
          <SubMenu key="home2" title={<span><Icon type="laptop" />多菜单</span>}>
            <MenuItem key="home2-index">option5</MenuItem>
            <MenuItem key="home2-index2">option6</MenuItem>
            <MenuItem key="home2-index3">option7</MenuItem>
            <MenuItem key="home2-index4">阿里图标库</MenuItem>
          </SubMenu>
          <SubMenu key="home3" title={<span><Icon type="notification" />常用组件</span>}>
